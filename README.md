...
Then every 5 minutes, I check if the spread gets too large or too low I predict that I will adapt back to its normal spread and I thus launch orders accordingly to my prediction. 

When the spread gets back to normal I close the position for both stocks.
